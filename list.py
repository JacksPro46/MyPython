...
list_num.extend(list_string) ## output will be [20, 30, 40, 50, 60, 70, 80, 90, 'Jagan', 'Mohan', 'Krishna', 'Gudela', 'Ravi', 'Teja']
...
another_list_nums.sort(reverse=True) ## output will be descending order to ascending [820, 98, 91, 90, 79, 74, 54, 51, 38, 11, 7, 1, 0]
